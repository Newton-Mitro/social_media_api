...
it('successfully updates the cover photo', function () {
    // Register User
    ...
    $file = new UploadedFile(
        ...
        'coverPhoto.png', // Original name of the file
    ...
    $response = $this->withToken($access_token)->postJson('/api/user/cover/picture/update', [
        'coverPhoto' => $file,
    ]);
